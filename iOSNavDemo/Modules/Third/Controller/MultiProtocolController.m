...
- (void)viewDidLoad {
    ...
    textView.text = @"《这是协议一》《这是协议二》《这是协议三》《友好互助条约一》《友好互助条约二》";
    textView.textColor = kNavBarColor;
    ...
    CGSize size = [self labelRectWithSize:CGSizeMake(SCREEN_Width - 30, CGFLOAT_MAX) LabelText:@"《这是协议一》《这是协议二》《这是协议三》《友好互助条约一》《友好互助条约二》" Font:Font(15)];
    [textView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.equalTo(@15);
        make.top.equalTo(@100);
        make.size.mas_equalTo(CGSizeMake(SCREEN_Width - 30, size.height + 20));
    }];
    
    //http://www.jianshu.com/p/1eb6c2c86cfb
    
    //http://www.jianshu.com/p/fc1500a2b936
